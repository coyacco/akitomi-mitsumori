...
//     torihiki_jouken: Option<String>,
//     yukou_kigen: Option<String>,
//     ukewatashi_kijitu: Option<String>,
//     ukewatashi_basho: Option<String>,
//     goukei: Option<f64>,
//     sotozeigaku: Option<f64>,
//     zeiritsu: Option<f64>,
//     zei_type: Option<String>,
//     kaishain: Option<String>,
// }
...
//             FROM mitsumori
//             WHERE mitsumorisaki_meisho LIKE ?
...
//     let like_param = format!("%{}%", searchClient);
//     let disp_num_i64 = disp_num as i64;
//     let offset_i64 = offset as i64;

//     let params: &[&dyn ToSql] = &[&like_param, &disp_num_i64, &offset_i64];
...
//                 keisho: row.get(3).ok(),
//                 goukei_kingaku: row.get::<_, Option<f64>>(4).ok().flatten(),
//                 items: vec![],
//             })
//         })
//         .map_err(|e| e.to_string())?;
